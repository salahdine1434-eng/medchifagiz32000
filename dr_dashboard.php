            ...
            <div id="caseDetail">
                ...
                <div class="cd-layout">
                    ...
                    <div class="cd-main">
                        ...
                        <!-- 2.5) موضوع الاستشارة وتفاصيل الحالة (بطاقة أُعيدت بعد أن حُذفت أثناء تطوير المحادثة) -->
                        <div class="cd-card">
                            <div class="cd-card-title"><i class="fas fa-file-lines"></i> موضوع الاستشارة</div>
                            <p class="cd-case-subject" style="margin:0;font-weight:700;color:var(--text-primary,#0f172a);"></p>
                        </div>
                        <div class="cd-card">
                            <div class="cd-card-title"><i class="fas fa-align-left"></i> تفاصيل الحالة</div>
                            <p class="cd-case-desc" style="margin:0;line-height:1.8;white-space:pre-wrap;color:var(--text-secondary,#475569);"></p>
                        </div>
                        ...
                        <!-- 3.5) إضافة طبيب مشارك — تظهر عند الضغط على زر "إضافة طبيب مشارك"
                             أعلى الصفحة. تعيد استخدام نفس نظام بحث الأطباء (search_doctors.php)
                             ونفس تصميم بطاقات النتائج الموجودة أصلاً في نافذة إنشاء الاستشارة
                             (نفس الأصناف cnc-ext-*)، عبر consultation_details.js + dr_dashboard.js. -->
                        <div class="cd-card mc-hidden" id="cdAddPartBox">
                            <div class="cd-card-title">
                                <i class="fas fa-user-plus"></i> إضافة طبيب مشارك
                                <button type="button" id="cdAddPartCloseBtn" style="float:left;background:none;border:none;color:#64748b;cursor:pointer;font-size:0.85rem;" aria-label="إغلاق"><i class="fas fa-times"></i></button>
                            </div>
                            <div class="cnc-ext-search-wrap">
                                <i class="fas fa-magnifying-glass cnc-ext-search-icon"></i>
                                <input type="text" id="cdAddPartDoctorSearch" class="cnc-ext-search-input" placeholder="ابحث بالاسم، التخصص، أو الولاية..." autocomplete="off">
                            </div>
                            <div id="cdAddPartDoctorResults" class="cnc-ext-doc-results">
...
">
    ...
    <script src="consultation_chat.js"></script>
