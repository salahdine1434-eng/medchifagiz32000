 ...
 * - يُسمح بالإرسال للطرفين فقط: الطبيب المُنشئ (created_by) أو الطبيب
 *   المختار (assigned_doctor). أي طرف آخر يُرفض.
...
/* ===== جلب الحالة + التحقق من صلاحية الوصول (منشئ أو طبيب مختار) ===== */
try {
    $stmt = $pdo->prepare("
