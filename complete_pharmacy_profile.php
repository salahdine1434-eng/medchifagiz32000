...
<head>
    ...
    <title>إكمال معلومات الصيدلية</title>
...
<div class="container">
    ...
    <div class="card">
        <h2>إكمال معلومات الصيدلية</h2>

        <p class="verify-text">
            من فضلك أكمل معلومات الصيدلية للدخول إلى لوحة التحكم
        </p>
     ...
     <form method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="text" name="pharmacy_name" placeholder="اسم الصيدلية" required>
            </div>
