            ...
            <div id="caseDetail">
                ...
                <div class="cd-layout">
                    ...
                    <div class="cd-main">
                        ...
                        <!-- عنوان الاستشارة وتفاصيل الحالة (بطاقة واحدة — نفس تصميم MedChifaGiz) -->
                        <div class="cd-card">
                            <div class="cd-card-title"><i class="fas fa-file-lines"></i> موضوع الاستشارة وتفاصيل الحالة</div>
                            <p class="cd-case-subject" style="margin:0 0 12px;font-size:0.98rem;font-weight:800;color:var(--text-primary,#0f172a);line-height:1.6;"><span class="cd-line" style="width:55%;"></span></p>
                            <p class="cd-case-desc" style="margin:0;font-size:0.88rem;color:var(--text-secondary,#475569);line-height:1.9;white-space:pre-wrap;"><span class="cd-line" style="width:92%;height:9px;"></span></p>
                        </div>
