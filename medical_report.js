...
(function () {
    ...
    /* ─────────────────── إجراءات: تحميل PDF ─────────────────── */
    /*
     * يستخدم PDF نفس مستند الطباعة بالضبط (buildPrintHtml) المستعمل في زر «طباعة»،
     * فيصبح الـ PDF مطابقاً للطباعة: نفس الألوان والخطوط والعناوين والهوامش
     * والتوسيط ومحاذاة RTL. لم يتغيّر تصميم التقرير ولا منطق الطباعة.
     */
    function downloadPdf() {
        ...
        window.MedReportPDF.download({
            fileName: fileName,
            documentHtml: buildPrintHtml(),   // نفس قالب الطباعة تماماً
            onError: function () {
                toast('سيتم استخدام الطباعة لحفظ PDF');
                printReport();
            }
