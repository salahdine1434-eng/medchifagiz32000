 ...
 * ---------------------------------------------------------------------------
 * مرحلة المحادثة الحقيقية — إرسال رسالة نصية داخل استشارة وحفظها في قاعدة
 * البيانات. (رسائل الصور تُرسَل عبر upload_consultation_files.php المستقل).
 *
...
/* ===== حفظ الرسالة (نصية دائماً هنا — type='text') ===== */
try {
    $ins = $pdo->prepare("
        INSERT INTO consultation_messages (consultation_case_id, sender_id, sender_type, message, type)
        VALUES (?, ?, ?, ?, 'text')
    ");
